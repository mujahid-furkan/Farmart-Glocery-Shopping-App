...
const HomeHero = () => {
  return (
    <section class="py-10" style={setBackgroundImage("/images/hero-bg.jpg")}>
      <div class="container">
        <div className="flex gap-8 flex-wrap">
          ...
          >
            <div className="flex flex-col justify-between h-full">
              <div>
                ...
                <p className="text-color md:mt-7 mt-4">
          ...
          {/* Hero Right Banner */}
          <div
            className="md:w-1/3 w-full md:py-16 md:px-12 py-10 px-6 rounded-lg"
